...
\begin{itemize}
    \item Developed and automated a Python-based system to scrape, process, and present data for the Green Finance Policy Database, improving efficiency and accessibility for researchers
\end{itemize}
\noindent
