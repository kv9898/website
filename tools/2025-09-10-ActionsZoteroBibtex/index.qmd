...
👉 [GitHub: kv9898/actions-zotero-bibtex](https://github.com/kv9898/actions-zotero-bibtex)

## Features

- 📚 Supports both **user** and **group** Zotero collections.  
- 🔑 Preserves *pinned citation keys* stored in Zotero's **Extra** field.  
- 🧹 Cleans up `type` fields to avoid nested braces like `{Policy {Contribution}}`.  
- 🔒 Protects acronyms (e.g. `IMF`, `OECD`) with extra braces in titles.  
- 🌐 Fully scriptable inside a CI/CD pipeline (e.g. for Quarto, LaTeX, or R Markdown builds).  
...
- User collection:
  https://www.zotero.org/username/collections/5SR8EG4D → library-id = <numeric user ID>, coll-key = 5SR8EG4D

- Group collection:
  https://www.zotero.org/groups/5979835/<groupname>/collections/HY6TKCRU → library-id = 5979835, coll-key = HY6TKCRU
